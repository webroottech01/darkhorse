...
<div class="container">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="productCategoryName" value="{{ old('productCategoryName', $product->productCategoryName) }}" class="form-control">
        </div>

        <div class="mb-3">
            <label>POS ID</label>
            <input type="text" name="posProductId" value="{{ old('posProductId', $product->posProductId) }}" class="form-control">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="focus_keywords" value="{{ old('focus_keywords', $product->focus_keywords) }}" class="form-control">
        </div>
